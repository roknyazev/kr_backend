...
def drop_off(order: Order, drone_queue: multiprocessing.Queue):
...
def pick_up(order: Order, drone_queue: multiprocessing.Queue):
...
def deliver_between_hubs(slot: ScheduleSlot, drone_queue: multiprocessing.Queue):
...
if __name__ == '__main__':
    processes = []
    validated_hubs = open("../global/validated_hubs.txt")
