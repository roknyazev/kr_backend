  ...
  mounted() {
    ...
    if (this.appDark) {
      this.mapTile = L.tileLayer
        .colorFilter('http://{s}.basemaps.cartocdn.com/dark_nolabels/{z}/{x}/{y}.png', {
  ...
  methods: {
    ...
    initPixiOverlay() {
      ...
      loader.load((loader, resources) => {
        ...
        this.HubsFromApi.small.forEach((item) => {
          ...
          marker.beginFill(0x4287f5, 0.25);
          marker.lineStyle(5, 0x4287f5, 1);
          marker.drawCircle(projection.x, projection.y, 15);
          marker.endFill();
          marker.interactive = true;
          marker.buttonMode = true;
          ...
          circle.beginFill(0x4287f5, 0.25);
          ...
          marker.on("pointerup", () => {
            console.log((item.Latitude * 180) / Math.PI, (item.Longitude * 180) / Math.PI)
            if (!marker.isClicked) {
        ...
        this.HubsFromApi.medium.forEach((item) => {
          ...
          marker.beginFill(0xdc2eff, 0.25);
          marker.lineStyle(5, 0xdc2eff, 1);
          marker.drawCircle(projection.x, projection.y, 20);
          marker.endFill();
          marker.interactive = true;
          marker.buttonMode = true;
          marker.zIndex = item.Id;
          ...
          let circle = new PIXI.Graphics();
          circle.beginFill(0xdc2eff, 0.25);
        ...
        this.HubsFromApi.large.forEach((item) => {
          ...
          marker.beginFill(0x2effab, 0.25);
          marker.lineStyle(5, 0x2effab, 1);
          marker.drawCircle(projection.x, projection.y, 25);
          marker.endFill();
          marker.interactive = true;
          marker.buttonMode = true;
          marker.zIndex = item.Id;
          ...
          marker.isClicked = false;
          let circle = new PIXI.Graphics();
          circle.beginFill(0x2effab, 0.25);
    ...
    updateUavs() {
      ...
      while (i < length + 4) {
        ...
        } else if (zoom >= 10) mk.scale.set(target_scale / 2.5);
